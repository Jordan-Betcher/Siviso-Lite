...
public class Map
{
	...
	public Map(SupportMapFragment supportMapFragment, LocationManager locationManager, Store$Home store$Home, Resources resources, Permission$AccessFineLocation permission)
	{
