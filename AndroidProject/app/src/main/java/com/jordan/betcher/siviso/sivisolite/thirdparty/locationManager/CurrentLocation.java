...
//	static final long MINIMUM_DISTANCE = 10;
	...
	Resources resources)
	{
		...
		mapMinInterval = resources.getInteger(R.integer.map_min_time_interval_milliseconds);
		mapMinDistanceToUpdate = resources.getInteger(R.integer.map_min_distance_meters);
	}
